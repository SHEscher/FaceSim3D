# # # Training script for VICE in main study

# Script must be run from project root "FaceSim3D":
# bash ./code/facesim3d/modeling/VICE/bash_for_training/training_vice_main.sh
...
# Train VICE o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o
...
do
  echo "Running VICE on ${cond} data"
   ...
   # --results_dir ${p2results}/${cond} \
   # --plots_dir ${p2results}/${cond}/Plots
  ...
  # --triplets_dir ${p2data}/${cond} --n_objects ${n_faces} --modality ${modality} --init_dim ${dims} \
